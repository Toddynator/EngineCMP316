...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	error = wcscpy_s(vsFilename, 128, L"../EngineCMP316/Shaders/color.vs");
	if (error != 0)
	{
		return false;
	}
	...
	error = wcscpy_s(psFilename, 128, L"../EngineCMP316/Shaders/color.ps");
	if (error != 0)
	{
		return false;
	}
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	*/
	...
	// This setup MUST MATCH the VertexType stucture in the ModelClass and in the shader.
